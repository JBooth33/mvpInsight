...
//Pulls the User data from database before loading table
function getData () {
    API.getUsers()
    .then(res => {
        this.setState({
...
const columnData = [
    { id: 'ObjectID', numberic: false, disablePadding: true, label: 'User ID' },
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            data: [
                ...
                // createData(null, 111, 'Jonathon', 'Engelien', 7153237605, 'Admin', 'jonathon.engelien@gmail.com','active', null),
                // createData(null, 112, 'James', 'Smith', 7153237605, 'Admin', 'jonathon.engelien@gmail.com', 'active', null),
            ],
            page: 0,
            rowsPerPage: 25,
        };
